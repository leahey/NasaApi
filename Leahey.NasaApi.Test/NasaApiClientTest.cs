...
namespace Leahey.NasaApi.Test
{
    public class NasaApiClientTest
    {
        ...
        {
            var actual = NasaApiClient.ValidateRoverName(roverName);
        ...
        {
            var actual = NasaApiClient.ValidateCameraName(roverName, cameraName);
            Assert.Equal(expected, actual);
        }
        ...
        {
            Assert.Throws<MarsRoverPhotoApiException>(() => NasaApiClient.ConvertEarthDateString(invalidDate));
        }
        ...
        {
            var actual = NasaApiClient.TryConvertEarthDateString(invalidDate, out _);
            Assert.Equal(expected, actual);
        }
        ...
        {
            var actual = NasaApiClient.ConvertEarthDateString(earthDate);
            Assert.Equal(expected, actual);
        }
        ...
        {
            Assert.Throws(exceptionType, () => NasaApiClient.BuildMarsRoverUrlString(roverName, null, null));
        }
        ...
        {
            Assert.Throws<MarsRoverPhotoApiException>(() => NasaApiClient.BuildMarsRoverUrlString(roverName, null, null, "", cameraName));
        }
        ...
        public void BuildMarsRoverUrlString_ForGivenValues_ShouldReturnProperUrl(string roverName, 
            ...
            string expected)
        {
            var actual = NasaApiClient.BuildMarsRoverUrlString(roverName, page, sol, earthDate, cameraName);
            Assert.Equal(expected, actual);
        }
    }
}
